...
const APPLE_ENGAGEMENT_ID = 'agent-qa-eng-apple-itgc'
...
function createInitialState(): MockState {
  ...
  state.entries.push(
    makeEntry(state, {
      ...
      engagementId: APPLE_ENGAGEMENT_ID,
  ...
  const candidates: CalendarExtractCandidate[] = [
    {
      ...
      extractedText: 'Control sync with Apple',
      sourceText: 'Control sync with Apple, 11:30 AM - 12:00 PM',
      confidence: 0.96,
      engagementId: APPLE_ENGAGEMENT_ID,
      activityId: WALKTHROUGH_ACTIVITY_ID,
      engagementCode: 'A100',
      engagementName: 'Apple ITGC',
      engagementType: 'external',
      activityCode: 'WALK',
...
function transcribeAudio(input: TranscribeAudioInput): TranscribeAudioResult {
  return {
    transcriptText: 'QA voice note: 30 minutes testing Apple ITGC controls.',
